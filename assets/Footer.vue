<template>
  <footer class="footer">
    ...
    <div class="stats">
      访问次数：<span id="vercount_value_site_pv">😯</span>次 | 访客人数：<span
    ...
    <div class="project-links">
      <strong>acmeshop:</strong
      ><a
        href="https://github.com/52op/FlareDrive-R2"
        target="_blank"
        rel="noopener noreferrer"
        >FlareDrive-R2增强版</a
      >
      <strong>感谢:</strong
      ><a
        href="https://github.com/willow-god/FlareDrive-R2"
        target="_blank"
        rel="noopener noreferrer"
        >FlareDrive-R2</a
      >
      <strong>初始项目:</strong
      ><a
        href="https://github.com/ljxi/Cloudflare-R2-oss"
        target="_blank"
        rel="noopener noreferrer"
        >Cloudflare-R2-OSS</a
      >
...
export default {
  ...
  data() {
    return {
      homeUrl: "https://13609822916.eu.cc//",
      blogUrl: "https://13609822916.eu.cc//",
      githubUrl: "https://13609822916.eu.cc/",
      emailUrl: "https://13609822916.eu.cc/",
    };
  },
};
</script>
